            ...
            <div class="col-12 col-xl-11">
                <div class="card shadow-lg border-0" style="border-radius: 20px; overflow: hidden;">
                    ...
                    <div class="card-body p-5">
                        <form action="{{ route('public.complaints.store') }}" method="POST"
                            ...
                            <div class="row g-4 mb-5 pb-4 border-bottom">
                                <div class="col-6 col-md-3">
                                    <div class="p-3 bg-white rounded-4 text-center shadow-sm h-100">
                                        <label
                                            class="form-label small text-muted text-uppercase fw-bold d-block mb-1">Created
                                            Date</label>
                                ...
                                <div class="col-6 col-md-3">
                                    <div class="p-3 bg-white rounded-4 text-center shadow-sm h-100">
                                        <label
                                            class="form-label small text-muted text-uppercase fw-bold d-block mb-1">Delivery
                                            Timeline</label>

                                        <select name="delivery_timeline"
                                            class="form-select bg-warning text-dark border-0 px-3 py-2 rounded-pill text-center shadow-sm fw-bold mx-auto"
                                            style="width: auto; min-width: 130px; cursor: pointer;">
                                            @for($i = 1; $i <= 7; $i++) <option value="{{ $i }}" {{ $i==3 ? 'selected'
                                                : '' }} class="bg-white text-dark">{{ $i }} {{ $i == 1 ? 'Day' : 'Days'
                                                }}</option>
                                                @endfor
                                        </select>
                                ...
                                <div class="col-6 col-md-3 text-center">
                                    <div
                                        class="p-3 bg-white border rounded-4 d-flex align-items-center justify-content-center h-100 shadow-sm">
                                        <div class="text-center">
                                            <p class="mb-0 small text-muted">Verified User:</p>
                                            <p class="mb-0 fw-bold text-primary small text-break">{{
                                                \App\Models\ComplaintUser::find(session('complaint_user_id'))->email }}
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row g-4 mb-5">
                                <div class="col-md-6">
                                    <div class="mb-4">
                                        <label class="form-label fw-bold">Issue Type <span
                                                class="text-danger">*</span></label>
                                        <select name="issue_type_id"
                                            class="form-select bg-light border-0 py-3 rounded-4" required>
                                    ...
                                    <div class="mb-4">
                                        <label class="form-label fw-bold">Department <span
                                                class="text-danger">*</span></label>
                                    ...
                                    <div class="mb-4">
                                        <label class="form-label fw-bold">Title <span class="text-danger">*</span>
                                            <small class="text-muted fw-normal">(Max 1000 chars)</small></label>
                                        <input type="text" name="title"
                                            class="form-control bg-light border-0 py-3 rounded-4"
                                            placeholder="Brief subject/title" required maxlength="1000">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-4">
                                        <label class="form-label fw-bold">Detailed Description <span
                                                class="text-danger">*</span></label>
                                        <textarea name="description"
                                            class="form-control bg-light border-0 py-3 rounded-4" rows="5"
                                            placeholder="Describe your issue in detail..." required
                                            style="height: 155px;"></textarea>
                                    </div>
                                    <div class="mb-4">
                                        <label class="form-label fw-bold">File Attach (Multiple Attachment - Image + PDF
                                            + Excel)</label>
                                        <input type="file" name="attachments[]"
                                            class="form-control bg-light border-0 py-2 rounded-4" multiple>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card bg-light border-0 rounded-4 mb-5">
                                <div class="card-body p-4">
                                    <div class="row align-items-center">
                                        <div class="col-md-4">
                                            <label class="form-label fw-bold">Specific Tag? <span
                                                    class="text-danger">*</span></label>
                                            <div class="d-flex gap-4 mt-2">
                                                <div class="form-check custom-radio">
                                                    <input class="form-check-input" type="radio" name="specific_tag"
                                                        id="tag_yes" value="1" onclick="toggleEmployee(true)">
                                                    <label class="form-check-label" for="tag_yes">Yes</label>
                                                </div>
                                                <div class="form-check custom-radio">
                                                    <input class="form-check-input" type="radio" name="specific_tag"
                                                        id="tag_no" value="0" checked onclick="toggleEmployee(false)">
                                        ...
                                        <div class="col-md-8" id="employee_area" style="display: none;">
                                            <div class="row g-2">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="employee_mobile"
                                                        class="form-control rounded-pill border-0 shadow-sm"
                                    ...
                                    <div class="mt-4 pt-3 border-top">
                                        <div class="row align-items-center">
                                            <div class="col-md-12">
                                                <label
                                                    class="form-label fw-bold small text-muted text-uppercase">Managed
                                                    By: <span class="text-danger">*</span></label>
                                                <div class="d-flex gap-5 mt-1">
                                                    <div class="form-check custom-radio">
                                                        <input class="form-check-input" type="radio" name="managed_by"
                                                            id="managed_self" value="self with admin" checked required>
                                                        <label class="form-check-label fw-bold text-dark"
                                                            for="managed_self">Self with Admin</label>
                                                    </div>
                                                    <div class="form-check custom-radio">
                                                        <input class="form-check-input" type="radio" name="managed_by"
                                                            id="managed_admin" value="admin" required>
                                                        <label class="form-check-label fw-bold text-dark"
                                                            for="managed_admin">Admin</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="mt-4 pt-3 border-top">
                                        <label class="form-label fw-bold small text-muted">Do You Want to Send This
                                            Records through E-mail to The Employee? <span
                                                class="text-danger">*</span></label>
                                        <div class="d-flex gap-4 mt-1">
                                            <div class="form-check custom-radio">
                                                <input class="form-check-input" type="radio" name="send_mail"
                                                    id="mail_yes" value="1">
                                                <label class="form-check-label" for="mail_yes">Yes</label>
                                            </div>
                                            <div class="form-check custom-radio">
                                                <input class="form-check-input" type="radio" name="send_mail"
                                                    id="mail_no" value="0" checked>
                    ...
                    <div class="d-flex justify-content-end gap-3 mt-5">
                        <a href="{{ route('public.complaints.dashboard') }}"
                            class="btn btn-light px-5 py-3 rounded-pill fw-bold border shadow-sm"><i
...
<script>
    ...
    function addRow() {
        ...
        newRow.innerHTML = `
            <td class="ps-4"><input type="text" name="orders[${rowCount}][order_id]" class="form-control border shadow-sm" placeholder="Enter Order ID"></td>
            <td><input type="text" name="orders[${rowCount}][ref_no]" class="form-control border shadow-sm" placeholder="Enter Ref. No."></td>
            <td><input type="text" name="orders[${rowCount}][tracking_id]" class="form-control border shadow-sm" placeholder="Enter Tracking ID"></td>
