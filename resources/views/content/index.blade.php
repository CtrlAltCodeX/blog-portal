        ...
        <table class="table table-bordered table-striped table-responsive">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="max-content">{{ $row->preferred_date }}</div>
                    </td>
                    ...
                    <td>
                        <div class="max-content">
                            @if($row->attach_docs)
                                <a href="{{ asset('storage/' . $row->attach_docs) }}" target="_blank"
                                class="btn btn-sm btn-primary">View Doc</a>
                            @endif
                        </div>
                    </td>
                        ...
                        <div class="max-content">
                            @if($row->attach_url)
                                <button class="btn btn-sm btn-primary"
                                    onclick="window.open('{{ $row->attach_url }}', '_blank')">View URL</button>
                            @endif
                        </div>
                    </td>
