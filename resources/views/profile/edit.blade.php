            ...
            <div class="col-md-9 col-xl-9">
                        ...
                        <div>
                            <div class="form-group">
                                ...
                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror"
                                    name="name" value="{{ old('name') ?? $user->name }}" autocomplete="name" autofocus placeholder="Admin">
                            ...
                            <div class="form-group">
                                ...
                                <input id="mobile" type="text"
                                    ...
                                    value="{{ old('mobile') ?? $user->mobile }}" autocomplete="mobile" placeholder="Mobile">
                            ...
                            <div class="form-group">
                                <label for="father_name" class="form-label">{{ __('Father\'s Name') }}<span
                                        class="text-danger">*</span></label>
                                <input id="father_name" type="text"
                                    class="form-control @error('father_name') is-invalid @enderror" name="father_name"
                                    value="{{ old('father_name') ?? $user->father_name }}" autocomplete="father_name" placeholder="Father Name">
                            ...
                            <div class="form-group">
                                <label for="mother_name" class="form-label">{{ __('Mother\'s Name') }}<span
                                        class="text-danger">*</span></label>
                                <input id="mother_name" type="text"
                                    class="form-control @error('mother_name') is-invalid @enderror" name="mother_name"
                                    value="{{ old('mother_name') ?? $user->mother_name }}" autocomplete="mother_name" placeholder="Mother Name">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label for="aadhaar_no" class="form-label">{{ __('Aadhaar Number') }}<span
                                    class="text-danger">*</span></label>
                            <input id="aadhaar_no" type="text"
                                class="form-control @error('aadhaar_no') is-invalid @enderror" name="aadhaar_no"
                                value="{{ old('aadhaar_no') ?? $user->aadhaar_no }}" autocomplete="aadhaar_no" placeholder="Adhaar No.">
                        ...
                        <div class="form-group">
                            ...
                            <input id="state" type="text" class="form-control @error('state') is-invalid @enderror"
                                name="state" value="{{ old('state') ?? $user->state }}" autocomplete="state" placeholder="State">
                        ...
                        <div class="form-group">
                            ...
                            <input id="pincode" type="text" class="form-control @error('pincode') is-invalid @enderror"
                                name="pincode" value="{{ old('pincode') ?? $user->pincode }}" autocomplete="pincode" placeholder="Pincode">
                        ...
                        <div class="form-group">
                            <label for="full_address" class="form-label">{{ __('Full Address') }}<span
                                    class="text-danger">*</span></label>
                            <textarea id="full_address" class="form-control @error('full_address') is-invalid @enderror"
                                name="full_address" autocomplete="full_address"
                                placeholder="Full Address">{{ old('full_address') ?? $user->full_address }}</textarea>
                        ...
                        <div class="form-group">
                            <label for="current_password" class="form-label">{{ __('Current Password') }}<span
                                    class="text-danger">*</span></label>
                        ...
                        <div class="form-group">
                            ...
                            <input id="password" type="password"
                                ...
                                name="password" autocomplete="new-password" placeholder="Confirm Password">
                        ...
                        <div class="form-group">
                            <label for="password_confirmation" class="form-label">{{ __('Confirm New Password') }}<span
                                    class="text-danger">*</span></label>
                        ...
                        <div class="form-group">
                            <div id="fileInputContainer">
                                <div class="form-group">
                                    ...
                                    <div class="form-group mb-0" @error('profile')
                                        style="border: red 2px dotted;" @enderror>
                                        <input type="file" class="dropify @error('images') is-invalid @enderror" data-default-file="{{ $user->profile }}"
                                            data-bs-height="180" id="profile" name="profile" />
                                    </div>
