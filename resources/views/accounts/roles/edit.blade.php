                        ...
                        <div>
                            <div class="form-group">
                                <div class="d-flex align-items-center">
                                    ...
                                    <input id="name" type="text" class="m-2 w-50 form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') ?? $role->name }}"  autocomplete="name" autofocus placeholder="Name" {{ $role->name == 'Super Admin' ? 'Disabled' : '' }}>
                                </div>
