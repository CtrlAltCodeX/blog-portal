    ...
    <div class="card">
        <div class="card-header">
            <div class="page-header my-0 w-100 d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('sub-subcategories.create') }}" class="btn btn-primary">Add Sub-Category</a>
            </div>
        </div>
            ...
            <table class="table table-bordered text-center">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $subcategory->subParent?->name ?? '—' }}</td>
                        ...
                        <td>
                            <a href="{{ route('sub-subcategories.edit', $subcategory->id) }}" class="btn btn-sm btn-warning">Edit</a>
                            <form action="{{ route('sub-subcategories.destroy', $subcategory->id) }}" method="POST" style="display:inline;">
                                @csrf @method('DELETE')
