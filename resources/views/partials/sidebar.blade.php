    ...
    <div class="app-sidebar">
        ...
        <div class="main-sidemenu">
            ...
            <ul class="side-menu">
                ...
                <li class="slide {{ request()->is('admin/find-products') ? 'is-expanded' : '' }}">
                    <a class="side-menu__item  {{ request()->is('admin/find-products/amazon') ? 'active is-expanded' : '' }}" data-bs-toggle="slide" href="javascript:void(0)"><i class="side-menu__icon fe fe-lock"></i><span class="side-menu__label">{{ __('Find Products') }}</span><i class="angle fe fe-chevron-right"></i></a>
                    <ul class="slide-menu">
                        <li class="side-menu-label1"><a href="javascript:void(0)">Apps</a></li>
                        <li><a href="{{ route('amazon.find') }}" class="slide-item  {{ request()->is('admin/find-products/amazon') ? 'active' : '' }}">{{ __('Amazon') }}</a>
                        </li>
                    </ul>
                </li>
            </ul>
