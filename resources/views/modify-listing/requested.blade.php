        ...
        <div class="card-header border-bottom-0">
            <div class="tabs-menu1">
                <ul class="nav panel-tabs">
                    <li><a href="#tab1" class="active" data-bs-toggle="tab">Request For Update ({{ $requested->count() }})</a></li>
                    <li><a href="#tab2" data-bs-toggle="tab">Request Completed ({{ $completed->count() }})</a></li>
                </ul>
            </div>
        </div>
        <div class="card-body">
