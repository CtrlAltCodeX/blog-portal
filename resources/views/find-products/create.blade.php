                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                <label for="url" class="form-label">{{ __('Insta Mojo URL') }}<span class="text-danger">*</span></label>
                            ...
                            <div id="fileInputContainer">
                                <div class="form-group">
                                    ...
                                    <div class="form-group mb-0" @error('images') style="border: red 2px dotted;" @enderror>
                                        <input type="file" class="dropify @error('images') is-invalid @enderror" data-bs-height="180" id="fileInput1" name="images[]" value="{{ old('images')??$product->baseImage }}" data-default-file='{{ $product->baseImage??"" }}' />
                                    </div>
