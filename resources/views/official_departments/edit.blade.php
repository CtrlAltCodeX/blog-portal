...
@section('title', 'Edit Official Department')
...
<div class="card">
    <div class='card-header'>
        <div class="page-header d-flex justify-content-between align-items-center my-0 w-100">
            <h1 class="page-title">Edit Official Department</h1>
            <a href="{{ route('official-departments.index') }}" class="btn btn-primary">Back</a>
        </div>
    </div>

    <div class="card-body">
        <form action="{{ route('official-departments.update', $department->id) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="form-group mb-3">
                <label for="name">Official Department Name</label>
            ...
            <div class="form-group mb-3">
                <label for="head">Official Department Head</label>
