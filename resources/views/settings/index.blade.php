            ...
            <div>
                <form action="{{ route('auth.google') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input id="client_id" type="text" class="form-control @error('client_id') is-invalid @enderror" name="client_id" {{ isset($creds->client_id) ? 'disabled' : '' }} value="{{ $creds->client_id??'' }}" autofocus placeholder="Google Client Id">
                    </div>

                    <div class="form-group">
                        <label for="name" class="form-label">{{ __('GOOGLE_CLIENT_SECRET') }}<span class="text-danger">*</span></label>

                        <input id="client_secret" type="text" class="form-control @error('client_secret') is-invalid @enderror" name="client_secret" {{ isset($creds->client_secret) ? 'disabled' : '' }} value="{{ $creds->client_secret??'' }}" autofocus placeholder="Google Client Secret">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input id="redirect_uri" type="text" class="form-control @error('callback_uri') is-invalid @enderror" name="redirect_uri" {{ isset($creds->redirect_uri) ? 'disabled' : '' }} value="{{ $creds->redirect_uri??'' }}" autofocus placeholder="Google Redirect URI">
                    </div>
